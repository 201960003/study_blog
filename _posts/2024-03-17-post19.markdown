...
<center>
  <img src="{{ "/assets/images/" | relative_url }}post19/1.png" alt="첫번째 사진">
</center>
ECONNREFUSED 오류는 일반적으로 네트워크 연결 문제를 나타나는데 

<center>
  <img src="{{ "/assets/images/" | relative_url }}post19/2.png" alt="두번째 사진">
</center>
...
<center>
  <img src="{{ "/assets/images/" | relative_url }}post19/3.png" alt="세번째 사진">
</center>
...
### 🤓 오류 해결시 나오는 화면
<center>
  <img src="{{ "/assets/images/" | relative_url }}post19/4.png" alt="네번째 사진">
</center>
