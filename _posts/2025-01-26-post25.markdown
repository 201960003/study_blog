...
<div class="sticker-container">
    <img class="sticker" src="{{ site.baseurl }}_includes/img/post25/four_leaf_clover.png">
    <img class="sticker" src="{{ site.baseurl }}_includes/img/post25/three_leaf_clover.png">
