...
<div class="sticker-container">
    <img class="sticker" src="{{ "/assets/images/" | relative_url }}post25/four_leaf_clover.png">
    <img class="sticker" src="{{ "/assets/images/" | relative_url }}post25/three_leaf_clover.png">
